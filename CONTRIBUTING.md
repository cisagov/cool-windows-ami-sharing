...
issue](https://github.com/cisagov/cool-windows-ami-sharing/issues) in this
...
request](https://github.com/cisagov/cool-windows-ami-sharing/pulls), you
...
```console
cd cool-windows-ami-sharing
pyenv virtualenv <python_version_to_use> cool-windows-ami-sharing
pyenv local cool-windows-ami-sharing
